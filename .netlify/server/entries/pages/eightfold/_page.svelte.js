...
const Eightfold = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h2>Buddha’s Eightfold Path</h2>
...
<p>“And what is right resolve? Aspiring to renunciation, to freedom from ill will, to harmlessness: This is called right resolve.</p>
<p>“And what is right speech? Abstaining from lying, from divisive speech, from abusive speech, &amp; from idle chatter: This is called right speech.</p>
<p>“And what is right action? Abstaining from taking life, from stealing, &amp; from sexual intercourse. This is called right action.</p>
<p>“And what is right livelihood? There is the case where a disciple of the noble ones, having abandoned dishonest livelihood, keeps his life going with right livelihood: This is called right livelihood.</p>

...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"grid grid-cols-2"}"><div class="${"container"}"><h1>Disclaimer</h1>
	...
	<section class="${"flex space-x-2"}"><a class="${"btn btn-filled-primary"}" href="${"https://kit.svelte.dev/"}" target="${"_blank"}" rel="${"noreferrer"}">SvelteKit</a>
		...
		<a class="${"btn btn-filled-tertiary"}" href="${"https://github.com/"}" target="${"_blank"}" rel="${"noreferrer"}">GitHub</a></section></div>





<div class="${"container"}">Some other stuff
</div></div>`;
});
export {
  Page as default

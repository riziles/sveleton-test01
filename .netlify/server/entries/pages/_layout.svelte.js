...
const css = {
  code: "svg.svelte-zgqaqk.svelte-zgqaqk{min-height:24px;transition:transform 0.3s ease-in-out}svg.svelte-zgqaqk line.svelte-zgqaqk{stroke:currentColor;stroke-width:3;transition:transform 0.3s ease-in-out\r\n	}button.svelte-zgqaqk.svelte-zgqaqk{z-index:20}.open.svelte-zgqaqk svg.svelte-zgqaqk{transform:scale(0.7)\r\n	}.open.svelte-zgqaqk #top.svelte-zgqaqk{transform:translate(6px, 0px) rotate(45deg)\r\n	}.open.svelte-zgqaqk #middle.svelte-zgqaqk{opacity:0}.open.svelte-zgqaqk #bottom.svelte-zgqaqk{transform:translate(-12px, 9px) rotate(-45deg)\r\n	}",
  map: null
};
const Hamburger = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<button class="${[
    "text-gray-500 hover:text-gray-700 cursor-pointer mr-4 border-none focus:outline-none svelte-zgqaqk",
    open ? "open" : ""
  ].join(" ").trim()}"><svg width="${"32"}" height="${"24"}" class="${"svelte-zgqaqk"}"><line id="${"top"}" x1="${"0"}" y1="${"2"}" x2="${"32"}" y2="${"2"}" class="${"svelte-zgqaqk"}"></line><line id="${"middle"}" x1="${"0"}" y1="${"12"}" x2="${"24"}" y2="${"12"}" class="${"svelte-zgqaqk"}"></line><line id="${"bottom"}" x1="${"0"}" y1="${"22"}" x2="${"32"}" y2="${"22"}" class="${"svelte-zgqaqk"}"></line></svg>
</button>`;
});
...
${validate_component(AppShell, "AppShell").$$render(
      ...
      {},
      {
		...
		${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
            ...
            lead: () => {
              return `${validate_component(Hamburger, "Hamburger").$$render(
                $$result,
                { open },
                {
                  open: ($$value) => {
            ...
            default: () => {
              return `<h1>Comparing Yoga and Buddhism</h1>`;
            }
          })}
